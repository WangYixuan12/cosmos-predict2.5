...
# Task 1: Scripted Sim ALOHA (4D actions)
scripted_sim_aloha_2b_128_128 = LazyDict(
    dict(
        defaults=[
            DEFAULT_CHECKPOINT.experiment,
            {"override /model": "action_conditioned_video2world_fsdp_rectified_flow"},
            {"override /net": "cosmos_v1_2B_action_conditioned"},
            {"override /conditioner": "action_conditioned_video_conditioner"},
            {"override /data_train": "scripted_sim_aloha_train"},
            {"override /data_val": "scripted_sim_aloha_val"},
            "_self_",
        ],
        job=dict(
            project="cosmos_predict2_action_conditioned",
            group="custom_tasks",
            name="scripted_sim_aloha",
        ),
        optimizer=dict(
            lr=2 ** (-14.5),
            weight_decay=0.1,
        ...
        model=dict(
            config=dict(
                ...
                state_t=1 + 12 // 4,
                net=dict(
                    action_dim=4,  # 4D actions for sim ALOHA
                    num_action_per_chunk=12,
                ),
            ),
        ),
...
# Task 2: Bimanual Rope (8D actions)
bimanual_rope_2b_128_128 = LazyDict(
    dict(
        defaults=[
            DEFAULT_CHECKPOINT.experiment,
            {"override /model": "action_conditioned_video2world_fsdp_rectified_flow"},
            {"override /net": "cosmos_v1_2B_action_conditioned"},
            {"override /conditioner": "action_conditioned_video_conditioner"},
            {"override /data_train": "bimanual_rope_train"},
            {"override /data_val": "bimanual_rope_val"},
            "_self_",
        ],
        job=dict(
            project="cosmos_predict2_action_conditioned",
        ...
        model=dict(
            config=dict(
                ...
                state_t=1 + 12 // 4,
                net=dict(
                    action_dim=8,  # 8D actions for bimanual rope
                    num_action_per_chunk=12,
                ),
            ),
        ),
...
# Task 3: Bimanual Box (14D actions)
bimanual_box_2b_128_128 = LazyDict(
    dict(
        defaults=[
            DEFAULT_CHECKPOINT.experiment,
            {"override /model": "action_conditioned_video2world_fsdp_rectified_flow"},
            {"override /net": "cosmos_v1_2B_action_conditioned"},
            {"override /conditioner": "action_conditioned_video_conditioner"},
            {"override /data_train": "bimanual_box_train"},
            {"override /data_val": "bimanual_box_val"},
            "_self_",
        ],
        job=dict(
            project="cosmos_predict2_action_conditioned",
        ...
        model=dict(
            config=dict(
                ...
                state_t=1 + 12 // 4,
                net=dict(
                    action_dim=14,  # 14D actions for bimanual box
                    num_action_per_chunk=12,
                ),
            ),
        ),
